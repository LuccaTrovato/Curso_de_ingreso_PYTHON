...
class App(customtkinter.CTk):
    ...
    def btn_validar_letra_on_click(self):
        letra = prompt("validar", "Ingresar una letra")

        while letra != "U" and letra != "T" and letra != "N":
            alert("Incorrecto","volver a ingresar la letra")
            letra = prompt("validar", "Reingresar una letra")
        
        alert("Ingreso", "Letra correcta")
