...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        sueldo_bruto = self.txt_sueldo.get()
        
        sueldo_numero = int(sueldo_bruto)

        aumento = sueldo_numero * 0.15

        sueldo_final = sueldo_numero + aumento

        alert("sueldo", f"Su sueldo con aumento es de {sueldo_final}")
